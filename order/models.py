...
class Order(models.Model):
    ...
    area_1 = models.DecimalField(default=0.00, max_digits=10, decimal_places=2)
    ...
    area_2 = models.DecimalField(default=0.00, max_digits=10, decimal_places=2)
    ...
    area_3 = models.DecimalField(default=0.00, max_digits=10, decimal_places=2)
    ...
    area_4 = models.DecimalField(default=0.00, max_digits=10, decimal_places=2)
